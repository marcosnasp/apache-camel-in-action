...
import br.example.camel.ch1.eip.SplitterComando;

public class MockSplitEipTest extends CamelTestSupport {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("jms:topic:comandoTopic").split().method(SplitterComando.class, "splitter").stopOnException()
                        .to("mock:quote");
            }
        };
    }
    ...
    public void testCamelFromJms() throws Exception {
        ...
        mockEndpoint.expectedBodiesReceived("ID0001");
