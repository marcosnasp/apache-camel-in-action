...
/**
 * Class to handle setting/removing MDC on per test case basis. This helps us log each test case into it's own log file. Please
 * see {@link http://logback.qos.ch/manual/appenders.html#SiftingAppender} and {@link http://logback.qos.ch/manual/mdc.html}
 * 
 * @author nullin
 */
